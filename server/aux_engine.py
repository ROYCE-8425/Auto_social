...
class _ApiAuxEngine:
    ...
    async def query(self, prompt: str):
        ...
        sysprompt += (
            ...
            "GỌI THẲNG TOOL: mặc định dùng gemini_generate_image để tạo cover ảnh thật (logo= file kit + images=1 raw, "
            "style_preference=authentic_photo nếu tool hỗ trợ; CẤM AI vẽ lại người/lớp học, CẤM AI full poster trừ khi brief ghi rõ ai_full). "
            "Nếu user yêu cầu ChatGPT/OpenAI/gpt-image/javis_generate_image hoặc phiên đang chọn OpenAI cho tạo ảnh, dùng javis_generate_image "
            "với page_id, logo/images nếu có, save_under='attachments/dataset/_xuat'. "
