...
description: "Bộ skill chuyên sâu viết bài Facebook: 4 trụ cột nội dung, 50 mẫu Hook thực chiến, sườn Hook-Body-CTA, cấm văn mẫu AI, tối ưu đọc lướt di động."
group: Content
---

# Kỹ năng viết bài Facebook thực chiến (Brand Voice Sao Việt)

Bộ chuẩn mực copywriting chuyển đổi cao, chắt lọc từ các trường phái Direct Response Copywriting (Dan Kennedy, Alex Hormozi) và hành vi đọc lướt của người dùng mạng xã hội Việt Nam.

Mục tiêu cốt lõi: **Nói tiếng người, đánh trúng việc thật, ngắn gọn, đồng cảm, loại bỏ 100% văn mẫu AI sáo rỗng.**

---

## 1. Bộ lọc "Anti-Văn-Mẫu AI" (Rào cản tuyệt đối)
...
## 3. Bốn trụ cột nội dung thực chiến (Content Matrix)

Mỗi bài viết thuộc 1 trong 4 trụ cột rõ ràng (đọc chi tiết tại `references/khung-viet-chuyen-doi.md`):

1. **Trụ cột A - Bài Tuyển sinh / Khóa học (Chuyển đổi & Chạy Ads):**
   - Đánh trúng nỗi sợ bị sếp nhắc nhở, áp lực công việc, mong muốn tăng lương hoặc đổi việc.
   - Đưa ra giải pháp học kèm 1-1, học đúng những gì công ty cần, không dạy lý thuyết lan man.
2. **Trụ cột B - Bài Chia sẻ Thủ thuật / Tips nhanh (Tương tác & Lưu bài):**
   - Hướng dẫn 1 mẹo xử lý công việc cực nhanh (thủ thuật Excel 10 giây, mẹo AutoCAD giảm nửa thời gian vẽ).
   - Định dạng danh sách bước 1, 2, 3 dễ áp dụng ngay.
3. **Trụ cột C - Câu chuyện học viên / Case Study (Xây dựng niềm tin):**
   - Người thật việc thật: Kể chuyện anh/chị học viên cụ thể (độ tuổi, nghề nghiệp, rào cản lúc mới tới).
   - Trải nghiệm được giáo viên kèm cặp kiên nhẫn và kết quả công việc sau khi hoàn thành khóa học.
4. **Trụ cột D - Thông báo / Lịch mở lớp / Khuyến mãi (Tạo sự khan hiếm):**
   - Lịch học ca tối, cuối tuần cho người bận rộn.
   - Giới hạn số lượng (mỗi ca chỉ nhận tối đa 5 bạn để giáo viên kèm sát).

---

## 4. Danh mục tài liệu tham chiếu

- Mẫu mở đầu giật hook: `references/bo-hook-thuc-chien.md`
- Sườn bài chi tiết từng trụ cột: `references/khung-viet-chuyen-doi.md`
- Dữ liệu cơ sở và thông tin thực tế: `references/du-lieu-thuc-te-fanpage-sao-viet.md`
- Giọng caption page chính (học từ bài cũ): `references/giong-page-chinh.md`
- Mẫu bài thực chiến Kế toán chuyển đổi cao: `references/mau-bai-ke-toan-chuyen-doi.md`
- Cẩm nang copywriting thực chiến đa ngành (Kế toán, Đồ họa, AI, n8n, Trẻ em): `references/cam-nang-content-da-nganh.md`
- Bộ bài viết mẫu thực chiến chuẩn (AutoCAD, Kế toán, Đồ họa, AI, n8n): `references/mau-that-tin-hoc-sao-viet.md`
