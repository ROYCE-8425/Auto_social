...
(Graph của Javis chưa nối page này; token hiện chỉ có Royce Shop + Pod. Caption dưới lấy từ bài đã index công khai, không bịa.)

Kit trang: `wiki/brand-kits/thsv-page-chinh.md`. Caption live: `sources/facebook-nhap/page-chinh-caption-live-2026-09.md`.
...
**Kieu 1 - Tieu de IN HOA + Cau hoi khơi goi / Tinh huong nghe nghiep:** Vi du: `🎨 KHOA HOC THIET KE DO HOA TAI TIN HOC SAO VIET...` hoac `❓ Hoc Ke Toan Co Kho Khong?`.
**Kieu 2 - Canh ban lam viec / Xuong gia cong:** Vi du: "Cam ban ve xuong xuong bi tra ve vi thieu kich thuoc...", sau do noi vao giai phap khoa hoc.
**Kieu 3 - Tuong phan gay soc / Nhan thuc:** Vi du: "Doanh nghiep cua ban dang dung AI, hay chi moi 'go lenh' voi AI?", "Lam viec cham chi khong con du, lam viec thong minh moi la loi the".
...
1. Dòng 1: emoji + TIÊU ĐỀ IN HOA (tên khóa + "TẠI TIN HỌC SAO VIỆT").
2. 2-5 dòng nỗi đau **đúng ngành**, mỗi dòng `👉`.
3. Câu chốt riêng bài, không copy "Học nhanh - thực hành nhiều - làm được ngay" nếu bài trước đã dùng.
4. CTA: Hotline/Zalo `093 11 44 858` + inbox.
5. Hashtag: `#tinhocsaoviet` + ngành.

## Giọng chữ (rút từ bài thật)

- Nói việc bàn làm việc: file Excel loay hoay, báo cáo mất hàng giờ, slide chưa chuyên nghiệp, nhờ đồng nghiệp sửa file.
- Cụm page chính dùng được **xoay**, không nhồi mỗi bài: "cầm tay chỉ việc", "không lý thuyết lan man", "học thực hành trực tiếp". Mỗi bài chọn **nhiều nhất 1** cụm này.
- Hook IN HOA kiểu: `CÔNG VIỆC NHIỀU NHƯNG THỜI GIAN ÍT?` / `"BIẾT TIN HỌC VĂN PHÒNG" KHÔNG CÒN LÀ LỢI THẾ… NHƯNG KHÔNG BIẾT → RẤT DỄ BỊ BỎ LẠI`
- Trả lời comment: xưng em, "em đã inbox để tư vấn chi tiết... chị vui lòng kiểm tra nhé".

## Cấm khi bắt chước page này

- Không mở "Bạn có biết / thời đại 4.0 / hãy cùng khám phá".
- Không caption 5 dòng rồi dừng (page chính bài khóa học dài, có list + chân trang).
- Không bịa học phí nếu brief không cho số. Page có lúc ghi ưu đãi % hoặc quà; Royce test: không bịa giá.
...
Chân trang pháp nhân (MST, email, web) lấy `_mac-dinh.md`. Địa chỉ: kit page đang đăng.

## Mau than bai page chinh (2026-09-03, do hoa)

Khong copy chu; chi lay nhip:

1. Tieu de emoji + IN HOA + "TAI TIN HOC SAO VIET"
2. 2 cau hoi viec that (mo Photoshop khong biet bat dau / y tuong ra may thi lech)
3. List `❌` noi dau dung nganh
4. 1 cau chot tu duy + quy trinh (NHAN YEU CAU -> XUAT SAN PHAM)
5. Module `✔` (cong cu, san pham lam duoc)
6. Doi tuong, 13 chi nhanh, hotline cach san `093 11 44 858`, email, inbox, hashtag
7. Khong MST. Khong bia hoc phi neu bai goc khong ghi gia.

## Bài đã đọc (link gốc)

- Đồ họa 2026-09-03 (page chính, caption dài module Photoshop/Illustrator): https://www.facebook.com/trungtamtinhocvanphongsaoviet
- AI Agent: https://www.facebook.com/trungtamtinhocvanphongsaoviet/posts/1350957097087599/ (ưu đãi 30% / 20 slot chỉ của bài này)
- Comment page: xưng em, "em đã inbox để tư vấn chi tiết... chị vui lòng kiểm tra nhé"
- THVP cấp tốc (cùng page, 2025-06): nỗi đau Excel/Word/PPT + 13 cơ sở + inbox
- Biết THVP không còn lợi thế: https://www.facebook.com/daotaotinhocsaoviet/posts (cùng hệ Sao Việt)
- Excel người mới (page Bình Thạnh): khai giảng, cầm tay chỉ việc, 093.1144.858
- Hè trẻ em: https://m.me/trungtamtinhocvanphongsaoviet
