...
1 goal = 1 page = 1 brief. Chân trang pháp nhân + MST 3603708616 + 0931144858 + email + tinhocsaoviet.com. Không em dash.

## 7. Tự duyệt rồi mới đăng, cấm đốt token (Luật G)

Trước khi gọi tool đăng, tự chấm 6 ô (đọc lại caption + file cover):

1. Caption chuẩn bài chuyển đổi cao (60-120 dòng), đầy đủ 7 phần (Tiêu đề IN HOA + emoji, nỗi đau, giải pháp, cam kết vàng, chi tiết module, ưu đãi, CTA và hệ thống 12-13 cơ sở). CẤM caption tóm tắt cụt lủn dưới 30 dòng. Cover và caption cùng ngành.
